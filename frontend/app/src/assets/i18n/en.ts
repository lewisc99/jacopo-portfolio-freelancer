  ...
  data: {
    ...
    references: {
      ...
      items: [
        ...
        {
          index: 8,
          clientName: 'GIULIO CAVAGNIS - FOUNDER CLOROFÓRMIO, CLOROGAMING',
        ...
        },
        {
          ...
          text: "'In a moment of conversation...' As a project coordinator at Ação Social Villaregia, in Centro de Acolhida Betâna, where Jacopo Giancaspro volunteered, it identifies him as an attentive person with a systemic vision. His expertise and dedication were crucial in turning ideas into projects and achieving visibility and results.",
